...
class AbstractFlowTable(object):
    ...
    def insert(self,attr1,attr2,attr3,attr4,attr5,attr6,attr7,attr8):
        """
            consente di inserire nella tabella un nuovo flusso (oppure aggiornarlo se già esiste)
        """
        idx=self._Hash(attr1,attr2,attr3,attr4,attr5,attr6,attr7,attr8) #calcolo funzione hash
        if not self._search(self._buckets[idx],attr1,attr2,attr3,attr4,attr5,attr6,attr7,attr8): #se nuovo flusso
            self._buckets[idx]=self._linkNewEntry(attr1,attr2,attr3,attr4,attr5,attr6,attr7,attr8,self._buckets[idx]) #inserisco flusso
    ...
    def _linkNewEntry(self,attr1,attr2,attr3,attr4,attr5,attr6,attr7,attr8,head): #abstract
        """
    ...
    def _Hash(self,attr1,attr2,attr3,attr4,attr5,attr6,attr7,attr8): #abstract
        """
            funzione hash
    ...
    def _search(self,head,attr1,attr2,attr3,attr4,attr5,attr6,attr7,attr8): #abstract
        """
            ricerca flusso
